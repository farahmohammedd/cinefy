...
import 'package:cinefy_app/features/movies/presentation/widgets/home_loading_shimmer.dart';
import 'package:cinefy_app/features/movies/presentation/widgets/error_state.dart';
import 'package:cinefy_app/core/error/failure_message.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final topRatedState = ref.watch(topRatedMoviesNotifierProvider);
                            ...
                            error: (error, stackTrace) {
                              return ErrorState(
                                ...
                                onRetry: () {
                                  ref
                                      .read(
                                        topRatedMoviesNotifierProvider.notifier,
                                      )
                                      .loadTopRatedMovies();
                                },
                              );
